...
//////// CLASS ////////
/// Manager responsible for spawning, configuring and coordinating boids behavior simulation
UCLASS()
...
public:
    ...
    void SetNumberOfBoids(const int32 NewValue);
...
private:
    ...
    // Alignment
    UPROPERTY(EditAnywhere, Category = "Boids|Behavior|Alignment", meta = (ClampMin = "1.0", ClampMax = "5.0"))
    ...
    UPROPERTY(EditAnywhere, Category = "Boids|Obstacle Avoidance", meta = (ClampMin = "1.0", ClampMax = "2000.0", EditCondition = "bEnableObstacleAvoidance"))
